...
public class SimpleHttpServer {
    // 处理HttpRequest的线程池
    static MyTreadPool<HttpRequestHandler> threadPool = new DefaultThreadPool
            <HttpRequestHandler>(1);
    // SimpleHttpServer的根路径 放在resources下好了
    static String basePath = "E:\\myworkspace\\SimpleTest\\src\\main\\resources";
